...
function DeviceMockup({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("style", null, `
    ...
    className: "dsb-mockup phone"
  }, /*#__PURE__*/React.createElement("img", {
    src: imageSrc,
    alt: imageAlt
  })) : /*#__PURE__*/React.createElement("div", {
    className: "dsb-mockup laptop"
  }, /*#__PURE__*/React.createElement("div", {
    className: "dsb-screen"
  }, /*#__PURE__*/React.createElement("img", {
    src: imageSrc,
    alt: imageAlt
  })), /*#__PURE__*/React.createElement("div", {
...
function CaseCard({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("style", null, `
      ...
      `), /*#__PURE__*/React.createElement("div", {
    className: `dsb-case ${side ? 'side' : ''}`
  }, imageSrc && !side && /*#__PURE__*/React.createElement(DeviceMockup, {
    device: device,
    imageSrc: imageSrc,
    imageAlt: imageAlt
  }), /*#__PURE__*/React.createElement("div", {
    className: "dsb-case-body"
  }, note && /*#__PURE__*/React.createElement("p", {
    className: "dsb-note"
  }, note), /*#__PURE__*/React.createElement("p", {
    className: "dsb-eb"
  }, eyebrow), /*#__PURE__*/React.createElement("h3", null, title), /*#__PURE__*/React.createElement("p", null, description), href && /*#__PURE__*/React.createElement("a", {
    className: "dsb-link",
    href: href,
    target: "_blank",
    rel: "noopener noreferrer"
  }, href.replace('https://', '').replace('http://', ''), " ↗")), imageSrc && side && /*#__PURE__*/React.createElement("div", {
    className: "dsb-case-media"
...
function PricingCard({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("style", null, `
      ...
      `), /*#__PURE__*/React.createElement("div", {
    className: `dsb-price ${featured ? 'featured' : ''}`
  }, badge && /*#__PURE__*/React.createElement("span", {
    className: "dsb-badge"
  }, badge), /*#__PURE__*/React.createElement("h4", null, name), /*#__PURE__*/React.createElement("p", {
    className: "dsb-amount"
  }, priceFrom), /*#__PURE__*/React.createElement("p", {
    className: "dsb-desc"
  }, description), features.length > 0 && /*#__PURE__*/React.createElement("ul", null, features.map((f, i) => /*#__PURE__*/React.createElement("li", {
    key: i
  }, f)))));
}
function EyebrowLabel({
  ...
  const Tag = as;
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("style", null, `.dsb-eyebrow{font-family:var(--font-mono);font-size:var(--text-eyebrow);font-weight:500;letter-spacing:var(--tracking-eyebrow);text-transform:uppercase;color:var(--copper);margin:0}`), /*#__PURE__*/React.createElement(Tag, {
    className: `dsb-eyebrow ${className}`
  }, children));
}
function SectionHeading({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("style", null, `
      ...
      `), /*#__PURE__*/React.createElement("div", {
    className: `dsb-sh ${className}`
  }, eyebrow && /*#__PURE__*/React.createElement(EyebrowLabel, null, eyebrow), /*#__PURE__*/React.createElement("h2", {
    className: "dsb-sh-h2"
...
function Tag({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("style", null, `.dsb-tag{font-family:var(--font-mono);font-size:12px;letter-spacing:.04em;text-transform:uppercase;color:var(--copper);border:1px solid var(--copper);border-radius:var(--radius-pill);padding:8px 14px;display:inline-block}`), /*#__PURE__*/React.createElement("span", {
    className: `dsb-tag ${className}`
  }, children));
}
function FormField({
  label,
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("style", null, `
      ...
      `), /*#__PURE__*/React.createElement("div", {
    className: `dsb-field ${error ? 'error' : ''}`
  }, /*#__PURE__*/React.createElement("label", {
    htmlFor: `field-${name}`
  }, label), isTextarea ? /*#__PURE__*/React.createElement("textarea", {
    id: `field-${name}`,
    name: name,
...
function MobileNav({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("style", null, `
    ...
    className: `dsb-burger ${open ? 'open' : ''}`,
    "aria-label": "Меню",
    "aria-expanded": open,
    onClick: () => onOpenChange(!open)
  }, /*#__PURE__*/React.createElement("span", null), /*#__PURE__*/React.createElement("span", null), /*#__PURE__*/React.createElement("span", null)), /*#__PURE__*/React.createElement("div", {
    className: `dsb-mobilemenu ${open ? 'open' : ''}`
  }, items.map(item => /*#__PURE__*/React.createElement("a", {
    key: item.anchor,
    href: item.anchor,
    className: item.anchor === current ? 'current' : '',
    onClick: e => {
      onOpenChange(false);
      if (onNavigate) onNavigate(item.anchor, e);
    }
  }, /*#__PURE__*/React.createElement("span", {
    className: "idx"
  }, item.index), item.label))));
}
function PersistentMobileCta({
  label = 'Обговорити проект',
  href = '#contact',
  visible
}) {
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("style", null, `
      ...
      `), /*#__PURE__*/React.createElement("div", {
    className: `dsb-pcta ${visible ? 'visible' : ''}`
  }, /*#__PURE__*/React.createElement(Button, {
    href: href,
    style: {
      width: '100%'
...
function SideNav({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("style", null, `
    ...
    className: "dsb-sidenav",
    "aria-label": "Секції сторінки"
  }, items.map(item => /*#__PURE__*/React.createElement("a", {
    key: item.anchor,
    href: item.anchor,
    className: item.anchor === current ? 'current' : '',
    onClick: onNavigate ? e => onNavigate(item.anchor, e) : undefined
  }, /*#__PURE__*/React.createElement("span", {
    className: "idx"
  }, item.index), /*#__PURE__*/React.createElement("span", null, item.label)))));
}
