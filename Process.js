...
function Process() {
  const steps = [{
    n: '01',
    title: 'Макет у Figma',
    desc: 'узгоджуємо структуру і зовнішній вигляд, перш ніж писати код.'
  }, {
    n: '02',
    title: 'Кастомний код на Astro',
    desc: 'верстаю сайт з нуля, без шаблонів і конструкторів.'
  }, {
    n: '03',
    title: 'Запуск і передача',
    desc: 'деплою сайт, передаю доступи, показую, де що знаходиться.'
  }];
  return /*#__PURE__*/React.createElement("section", {
    ...
    eyebrow: "Як я працюю",
    title: "Прозорий процес від макета до запуску"
  })), /*#__PURE__*/React.createElement(ScrollReveal, {
    as: "div",
    className: "lp-process-grid"
  }, steps.map(s => /*#__PURE__*/React.createElement("div", {
    className: "lp-step",
    key: s.n
  }, /*#__PURE__*/React.createElement("p", {
    className: "n"
  }, s.n), /*#__PURE__*/React.createElement("h3", null, s.title), /*#__PURE__*/React.createElement("p", null, s.desc)))), /*#__PURE__*/React.createElement(ScrollReveal, null, /*#__PURE__*/React.createElement("p", {
    className: "lp-process-note"
  }, "Оплата поетапна: частина на старті, частина після здачі. Технічні питання після запуску теж на мені, ви не лишаєтесь сам на сам зі своїм сайтом.")));
}
