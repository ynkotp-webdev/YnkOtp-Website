...
function Niches() {
  const niches = [{
    title: 'Їжа, кава, бари',
    desc: "кав'ярні, пекарні, кондитерські, бари"
  }, {
    title: 'Краса та відновлення',
    desc: 'салони краси, барбершопи, перукарні, косметологія'
  }, {
    title: 'Розваги та дозвілля',
    desc: "комп'ютерні клуби, квест-кімнати, лазертаг, дитячі ігрові кімнати"
  }];
  return /*#__PURE__*/React.createElement("section", {
    ...
    eyebrow: "Для кого",
    title: "Малий бізнес, якому важлива якість",
    description: "Три напрямки, з якими працюю найчастіше:"
  })), /*#__PURE__*/React.createElement(ScrollReveal, {
    as: "div",
    className: "lp-niches-grid"
  }, niches.map(n => /*#__PURE__*/React.createElement("div", {
    className: "lp-niche",
    key: n.title
  }, /*#__PURE__*/React.createElement("h3", null, n.title), /*#__PURE__*/React.createElement("p", null, n.desc)))), /*#__PURE__*/React.createElement(ScrollReveal, null, /*#__PURE__*/React.createElement("p", {
    className: "lp-niches-note"
  }, "Якщо ваш бізнес не входить в жоден із напрямків, це не привід не писати. Ніші обрані свідомо широко, головне, щоб сайт відповідав тому, як реально працює ваш бізнес.")));
}
